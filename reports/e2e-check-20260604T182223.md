...
- 生成时间: `2026-06-04T18:22:23+08:00`
...
| 平台 | 状态 | 通过步骤 | 总步骤 | 耗时 |
|---|---|---|---|---|
| 小红书 (`xiaohongshu`) | **✗ FAIL** | 6/7 | 7 | 925.9s |
...
| 2 | goto_upload_page | ✓ | 0.4s |  |
| 3 | upload_video_file | ✓ | 1.0s |  |
| 4 | wait_for_upload_complete | ✓ | 301.4s |  |
| 5 | upload_video | ✓ | 302.9s |  |
| 6 | upload_video_flow | ✓ | 312.9s |  |
